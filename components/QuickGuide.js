export function QuickGuide() {
  return (
    <aside className="quick-guide" aria-label="Resumo essencial">
      ...
      <div className="quick-model"><strong>Sol</strong><p>Potência para trabalho complexo e decisões importantes.</p></div>
      <div className="quick-model"><strong>Terra</strong><p>Equilíbrio para produzir bem todos os dias.</p></div>
      ...
      <nav className="article-index" aria-label="Índice do artigo">
        <span>Navegue pelo guia</span>
        <a href="#resumo">Modelos em 30 segundos</a>
        <a href="#precos">Preços da API</a>
